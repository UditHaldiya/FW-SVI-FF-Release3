...
Originally based on LCX's ad_l.c,54
    ...
    $Archive: /MNCB/Dev/LCX2AP/FIRMWARE/framework/bios/project_LCX/adhwconf.c $
    $Date: 12/15/11 3:47p $
    $Revision: 2 $
 ...
 *
 * *****************  Version 2  *****************
 * User: Justin Shriver Date: 12/15/11   Time: 3:47p
 * Updated in $/MNCB/Dev/LCX2AP/FIRMWARE/framework/bios/project_LCX
 * -- AP -- Verified power tables, corrected GPIO use.
 *
 * *****************  Version 1  *****************
...
#define POWER_BIT_MASK (0U | GPIO0_P_POS_INT | GPIO0_P_PRESS)
