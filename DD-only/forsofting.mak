...
GenVFD: tok $(DDL_root)\script\$(MAIN_SCRIPT)
...
default_tag=$(strip $(shell $(UNIMAL) default_tag.u))

$(DDL_root)\script\$(MAIN_SCRIPT) : $(DDL_root)\script\pre_$(MAIN_SCRIPT)
    $(MN_SED)  -e s/Replace_Me_/$(default_tag)/g $< >$@
