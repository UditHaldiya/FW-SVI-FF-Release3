...
#define FD_CONDITIONS_ENUM \
    { 0x00000001,  "|en|Internal Error",						  HLP5("|en|Internal Error") },\
    ...
    { 0x80000000,  "|en|TB Error",								  HLP5("|en|TB Error") }
#else
#endif

#if 0
#define FD_CONDITIONS_DISABLED_ENUM \
    { 0x00000001,  "|en|Internal Error disabled",						   HLP5("|en|Internal Error disabled") },\
    ...
    { 0x80000000,  "|en|TB Error Disabled",								   HLP5("|en|TB Error Disabled ") }
#else
