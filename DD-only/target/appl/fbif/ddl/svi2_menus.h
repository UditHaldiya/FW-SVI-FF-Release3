...
#define LBL_MN_CONF_SWITCHS                             "|en|Switches"
...
#define LBL_MN_DS_BLOCK_ERR                             "|en|Block Error"
#define LBL_MN_DS_BLOCK_ERR_UPDATE_EVT                  "|en|Block Error Update Evt"
...
#define LBL_MN_PV_SWITCHS                               "|en|Switches"
...
#define LBL_MN_CONF_MAINT_WORKING_TIME_ALERT            "|en|Working Times Alert"
#define LBL_MN_CONF_MAINT_FACTORY_USE                   "|en|Factory Use"
#define LBL_MN_CONF_MAINT_ERR_HISTOGRAM                 "|en|Error Histogram"
...
{
	LABEL "|en|Final Position Value D";
	STYLE(GROUP)
	ITEMS
	{
...
MENU mnu_startup
{
    ...
    ITEMS
    {
		...
		EDD(ROWBREAK)
		grp_travel_calibration
	}
}

MENU grp_working_pos
{
    LABEL "|en|Working Position";
    STYLE(GROUP)
    ITEMS
    {
		PARAM.WORKING_POS.STATUS
...
MENU grp_travel_calibration
{
    LABEL "|en|Travel Calibration";
    STYLE(GROUP)
    ITEMS
    {
		PARAM.TRAVEL_CALIBRATION.CAL_DATE(READ_ONLY)
		PARAM.TRAVEL_CALIBRATION.CAL_LOCATION(READ_ONLY)
		PARAM.TRAVEL_CALIBRATION.CAL_WHO(READ_ONLY)
		PARAM.TRAVEL_CALIBRATION.CAL_STOP_HI_POS(READ_ONLY)
		PARAM.TRAVEL_CALIBRATION.CAL_STOP_LO_POS(READ_ONLY)
		PARAM.TRAVEL_CALIBRATION.CAL_STOP_HI_POS
		PARAM.TRAVEL_CALIBRATION.CAL_STOP_LO_POS
		PARAM.TRAVEL_CALIBRATION.CAL_TYPE(READ_ONLY)
		PARAM.TRAVEL_CALIBRATION.LAST_RESULT(READ_ONLY)
		grp_working_pos
		replace_stops
	}
}
...
MENU mnu_positionErrorhistogram
{
    ...
    ITEMS
    {
		...
		refresh_position_error_histogram
    }
}
MENU mnu_workingTimes_histogram
{
    LABEL "|en|Working Times";
    STYLE(GROUP)
    ITEMS
    {
...
/*MENU grp_alert_state
{
	...
	ITEMS
	{
				...
				pic_cycleB_alert
				EDD(ROWBREAK)
				PARAM.ALERT_STATE.WORKING_TIME_ALERT_ST
				EDD(COLUMNBREAK)
				pic_wroktime_alert
		}
}*/
...
MENU grp_alert_count
{
	LABEL "|en|Alert Counts";
	STYLE(GROUP)
	ITEMS
	{
...
{
	LABEL "|en|Supply Pressure LoLo Alert";
	STYLE(GROUP)
	ITEMS
	{
...
{
	LABEL "|en|Supply Pressure Lo Alert";
	STYLE(GROUP)
	ITEMS
	{
...
{
	LABEL "|en|Supply Pressure Hi Alert";
	STYLE(GROUP)
	ITEMS
	{
...
MENU mnu_temperature_alerts
{
    ...
    ITEMS
    {
        ...
        EDD(ROWBREAK)
		mnu_temp_lo_alert_setting
        EDD(COLUMNBREAK)
        mnu_temp_hi_alert_setting
    }
}

MENU mnu_temp_lo_alert_setting
{
    LABEL "|en|Temperature Lo Alert";
    STYLE(GROUP)
    ITEMS
    {
...
MENU mnu_temp_hi_alert_setting
{
    LABEL "|en|Temperature Hi Alert";
    STYLE(GROUP)
    ITEMS
    {
...
{
	LABEL "|en|Discrete Switch 1 Configuration";
	STYLE(GROUP)
	ITEMS
	{
...
{
	LABEL "|en|Discrete Switch 2 Configuration";
	STYLE(GROUP)
	ITEMS
	{
...
MENU mnu_working_time_alert
{
    LABEL "|en|Working Time Alert";
    STYLE(GROUP)
    ITEMS
    {
...
{
    LABEL "|en|Final Value Cut-Off High";
    STYLE(GROUP)
    ITEMS
    {
...
{
	LABEL "|en|Final Value Cut-Off Low";
	STYLE(GROUP)
	ITEMS
	{
...
MENU mnu_config_lcddisplay
{
    ...
    ITEMS
    {
        ...
        PARAM.UI_CUSTOM_CONFIGURATION.CUSTOM_2_CONFIGURATION
			EDD(ROWBREAK)
			grp_ui_access_control
    }
}
MENU grp_ui_access_control
{
	LABEL "|en| UI Access Control";
	STYLE(GROUP)
	ITEMS {
		WHOLE_PARAM__UI_ACCESS_CONTROL
	}
}
...
MENU grp_Advancedkey
{
	LABEL "|en|Advanced Key";
	STYLE(GROUP)
	ITEMS {
		PARAM.ADVANCED[1]
		PARAM.ADVANCED[2]
...
MENU mnu_tb_exconfig_page
{
    ...
    ITEMS
    {
		...
		EDD(COLUMNBREAK)
        mnu_write_alm
/*		mnu_grant_deny */ /*Removed for duplicate with Option page. */
    }
}
...
MENU mnu_check_alm
{
    LABEL "|en|Check Alarm";
    STYLE(GROUP)
    ITEMS
    {
        PARAM.FD_CHECK_ALM.UNACKNOWLEDGED,
        PARAM.FD_CHECK_ALM.ALARM_STATE,
        PARAM.FD_CHECK_ALM.TIME_STAMP,
        PARAM.FD_CHECK_ALM.SUB_CODE,
        PARAM.FD_CHECK_ALM.VALUE
    }
}
MENU mnu_features
{
...
ITEMS
	...
	EDD(ROWBREAK)
	PARAM.FD_SIMULATE.DIAGNOSTIC_SIMULATE_VALUE
	EDD(COLUMNBREAK)
	PARAM.FD_SIMULATE.DIAGNOSTIC_VALUE
	}
}
	...
	ITEMS
{
	...
	PARAM.DATA_COLLECTION_TRIGGER.TRIGGER_BY_LOCAL_UI
...
STYLE(GROUP)
	...
	ITEMS
{
/*	PARAM.PST_TRIGGER.PST_TRIGGER_BY_UI */
