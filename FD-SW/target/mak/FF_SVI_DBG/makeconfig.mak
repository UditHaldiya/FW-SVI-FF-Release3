...
################################################################################
# configure target
$(warning I am here: $(CURDIR))
include ../makeconfig_common.mak

TARGET_NAME = FF_SVI_DBG
export MESSAGE = " Variant: $(ADD_COMM_COMP) ($(STACK_TYPE)) on $(HW_TYPE) / $(FB_CHIP): Debug (KD30) version"

    # Define active mode: DEBUG, RELEASE
export ACTIVE_MODE = DEBUG
