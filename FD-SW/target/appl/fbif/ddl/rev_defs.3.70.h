...
#define SFT_STD_XDCR_PARM_dev_rev        __STD_XDCR_PARM_beta_dev_rev      /*  Transducer Parameters     DD-LIB V3.70, 013E\01xx not available */
...
#define SFT_STD_XDCR_PARM_dd_rev         __STD_XDCR_PARM_beta_dd_rev      /*  Transducer Parameters     DD-LIB V3.70 */
