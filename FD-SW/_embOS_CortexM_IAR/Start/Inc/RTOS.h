...
*/
  ...
  // whether extended stack frame ist used or not.
...
typedef union { irqf_t *__fun; const void * __ptr; void *cptr;} intvec_elem;
extern const intvec_elem __int_vector_table[];
...
#define OS_VERSION_GENERIC (38604)       /*   Generic version 3.86d */
...
// If not defined in OSCHIP.h, the chip specific part of RTOS.h, OS_TASK_EVENT defaults to OS_U8 to be compatible to older versions
//
...
#define OS_ERR_TIMESLICE                      (117)    // A timeslice value of 0 (illegal) was set.
...
#if defined(OS_LIBMODE_XR) || defined(OS_LIBMODE_R)
//AK: This is a way to use the "R" build of the libraries instead of "S" build
#define OS_TCB_CPU_EX void * mn_StackBottom;
#endif
