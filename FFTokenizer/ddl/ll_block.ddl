/*
** @(#)ll_block.ddl    1.0 Thu May 23 10:21:43 2002

**
** FF standard Lead Lag block
** Filename: ll_block.ddl
...
**********************************************************************
** Lead Lag
** Definition of Lead Lag Block
**********************************************************************
*/
BLOCK   __lead_lag
{
        CHARACTERISTICS __ll_character ;
        LABEL                              [lead_lag_block] ;
        HELP                               [lead_lag_block_help] ;
        PARAMETERS
        {
            ST_REV,                     __st_rev ;
            TAG_DESC,                   __tag_desc ;
            ...
            #else
            STATUS_OPTS,                __status_opts_ll ;
            #endif
            IN,                         __in ;
            FOLLOW,                     __follow ;
            LAG_TIME,                   __lag_time ;
            LEAD_TIME,                  __lead_time ;
            BAL_TIME,                   __bal_time ;
...
VARIABLE_LIST   __ll_view_4
{
        ...
        MEMBERS
        {
            ...
            VL_LAG_TIME,                     PARAM.LAG_TIME ;
            VL_LEAD_TIME,                    PARAM.LEAD_TIME ;
