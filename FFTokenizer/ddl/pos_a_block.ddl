/*
** @(#)pos_a_block.ddl      1.0	2009-06-15
**
** FF Standard Advanced Analog Positioner Transducer Block
** Filename: pos_a_block.ddl
...
** Description:
** 	Standard Advanced Analog Positioner Basic Device
**
...
/*
**********************************************************************
** Standard Advanced Analog Positioner Transducer Block
**********************************************************************
*/
MANUFACTURER    __FF,
...
**********************************************************************
*/
BLOCK   __pos_a_xdcr_block
{
        CHARACTERISTICS		__pos_a_xdcr_character ;
        LABEL                   [pos_a_xdcr_block] ;
        HELP                    [pos_a_xdcr_block_help] ;
        PARAMETERS
        {
                ST_REV,		__st_rev ;
		TAG_DESC,		__tag_desc ;
        ...
        PARAMETER_LISTS
        {
                VIEW_1, __pos_a_xdcr_view_1 ;
                VIEW_2, __pos_a_xdcr_view_2 ;
                VIEW_3, __pos_a_xdcr_view_3 ;
                VIEW_4, __pos_a_xdcr_view_4 ;
        }
        UNIT_ITEMS
	{
		__unit_pos_a_fvr_unit
        }
        
        #ifdef UD_LISTS
	COLLECTION_ITEMS
	{
		no_download_pos_a_xdcr
		,upload_wanted_pos_a_xdcr
	}
	#endif
}
/*
...
**********************************************************************
*/
VARIABLE_LIST   __pos_a_xdcr_view_1
{
        LABEL           [pos_a_xdcr_view_1] ;
        HELP            [pos_a_xdcr_view_1_help] ;
        MEMBERS
        {
...
VARIABLE_LIST   __pos_a_xdcr_view_2
{
        LABEL           [pos_a_xdcr_view_2] ;
        HELP            [pos_a_xdcr_view_2_help] ;
        MEMBERS
        {
                VL_ST_REV,		PARAM.ST_REV ;
		VL_TRANSDUCER_TYPE,		PARAM.TRANSDUCER_TYPE ;
...
VARIABLE_LIST   __pos_a_xdcr_view_3
{
        LABEL           [pos_a_xdcr_view_3] ;
        HELP            [pos_a_xdcr_view_3_help] ;
        MEMBERS
        {
                VL_ST_REV,		PARAM.ST_REV ;
		VL_MODE_BLK,		PARAM.MODE_BLK ;
...
VARIABLE_LIST   __pos_a_xdcr_view_4
{
        LABEL           [pos_a_xdcr_view_4] ;
        HELP            [pos_a_xdcr_view_4_help] ;
        MEMBERS
        {
                /* View 4_1 */
        	VL_ST_REV,		PARAM.ST_REV ;
...
*/
#ifdef UD_LISTS
COLLECTION no_download_pos_a_xdcr
{
...
COLLECTION upload_wanted_pos_a_xdcr
{
