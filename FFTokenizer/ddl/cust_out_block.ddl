/*
** @(#)cust_out_block.ddl      1.0	2009-06-15
**
** FF Custom Output Block
** Filename: cust_out_block.ddl
...
** Description:
** 	"Skeleton" block definition as per FF-890 Output Function
...
{
        CHARACTERISTICS		__custom_out_character ;
        LABEL                   [custom_out_block] ;
        HELP                    [custom_out_block_help] ;
        PARAMETERS
        {
                ST_REV,				__st_rev ;
                TAG_DESC,                       __tag_desc ;
        ...
        PARAMETER_LISTS
        {
                VIEW_1, __custom_out_view_1 ;
                VIEW_2, __custom_out_view_2 ;
                VIEW_3, __custom_out_view_3 ;
                VIEW_4, __custom_out_view_4 ;
        }
        
        #ifdef UD_LISTS
	COLLECTION_ITEMS
	{
		no_download_custom_out
		,upload_wanted_custom_out
	}
	#endif
}
/*
...
{
        LABEL           [custom_out_view_1] ;
        HELP            [custom_out_view_1_help] ;
        MEMBERS
        {
...
{
        LABEL           [custom_out_view_2] ;
        HELP            [custom_out_view_2_help] ;
        MEMBERS
        {
                VL_ST_REV,     		PARAM.ST_REV ;
        }
...
{
        LABEL           [custom_out_view_3] ;
        HELP            [custom_out_view_3_help] ;
        MEMBERS
        {
                VL_ST_REV,              PARAM.ST_REV ;
                VL_MODE_BLK,            PARAM.MODE_BLK ;
...
{
        LABEL           [custom_out_view_4] ;
        HELP            [custom_out_view_4_help] ;
        MEMBERS
        {
                VL_ST_REV,		PARAM.ST_REV ;
...
*/
#ifdef UD_LISTS
COLLECTION no_download_custom_out
{
...
COLLECTION upload_wanted_custom_out
{
