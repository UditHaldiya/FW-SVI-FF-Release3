/*
** @(#)temp_c2s.ddl	1.0	2007-28-09
**
** Standard Temperature with Calibration Two Sensor Device Access
** Filename: temp_c2s.ddl
...
**
** Date of last change: 2006-08-18
** Description:
**
**
...
/*
** HISTORY:
**      ED      Revision 0.1    2006-06-20
**              Initial version
**      ED      Revision 0.2beta 7 2006-08-17
**              added MODULE_SN to View 4 per AR# 2071
**      ED      Revision 0.2beta 7 2006-08-17
**              added ST_REV to multiple View 4 sections per AR# 2072
...
**********************************************************************
*/
BLOCK   __temperature_cal_basic_2_sensor
{
    CHARACTERISTICS         __tc2s_character ;
    LABEL                  [temperature_basic_2_sensor_block] ;
    ...
    PARAMETER_LISTS
    {
        VIEW_1, __tc2s_view_1 ;
        VIEW_2, __tc2s_view_2 ;
        VIEW_3, __tc2s_view_3 ;
        VIEW_4, __tc2s_view_4 ;
    }
    UNIT_ITEMS
    {
        __unit_tc2s_cal_unit_1,
        __unit_tc2s_sensor_range_1,
        __unit_tc2s_primary_val_1,
        __unit_tc2s_cal_unit_2,
        __unit_tc2s_sensor_range_2,
        __unit_tc2s_primary_val_2,
        __unit_tc2s_second_val
    }
