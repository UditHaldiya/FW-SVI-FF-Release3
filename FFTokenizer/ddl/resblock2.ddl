/*
** @(#)resblock2.ddl 1.0 1999-12-01
**
** FF standard Resource block
** Filename: resblock2.ddl
...
** DISCLAIMER OF WARRANTIES
**
** (c) Fieldbus Foundation(TM) (1999-2005)
**
*/

/*
** HISTORY:
**  SBM Revision 1.0  1999-12-01 Created
...
{
    CHARACTERISTICS     __res_2_character ;
    LABEL               [resource_block_2] ;
    HELP                [resource_block_2_help] ;
    PARAMETERS
    {
        ST_REV,         __st_rev ;
        TAG_DESC,       __tag_desc ;
    ...
    PARAMETER_LISTS
    {
        VIEW_1, __res_2_view_1 ;
        VIEW_2, __res_2_view_2 ;
        VIEW_3, __res_2_view_3 ;
        VIEW_4, __res_2_view_4 ;
    }
...
VARIABLE_LIST   __res_2_view_2
{
    LABEL       [res_2_view_2] ;
    HELP        [res_2_view_2_help] ;
    MEMBERS
    {
        VL_ST_REV,          PARAM.ST_REV ;
...
COLLECTION upload_wanted_res_2
{
