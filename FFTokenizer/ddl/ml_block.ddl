/*
** @(#)ml_block.ddl     1.1 1999-03-04
**
** FF standard Manual Loader block
** Filename: ml_block.ddl
...
**       added new rev number system for dev rev and dd rev
...
**********************************************************************
** Manual Loader
** Definition of a manual loader block
**********************************************************************
*/
BLOCK   __manual_loader_block
{
        CHARACTERISTICS     __ml_character ;
        LABEL                           [manual_loader_block] ;
        HELP                            [manual_loader_block_help] ;
        PARAMETERS
        {
                ST_REV,                 __st_rev ;
                TAG_DESC,               __tag_desc ;
                ...
                #else
                CONTROL_OPTS,   	__control_opts_ml ;
                STATUS_OPTS,    	__status_opts_ml ;
                #endif
                IN,                     __in ;
                PV_FTIME,               __pv_ftime ;
                BKCAL_IN,               __bkcal_in ;
                ...
                #else
                ALARM_SUM,              __alarm_sum_ml ;
                ACK_OPTION,             __ack_option_ml ;
                #endif
