/*
** @(#)mai16_block.ddl     1.0 2009-06-16
**
** FF standard Multiple Analog Input Function Block
** Filename: mai16_block.ddl
...
DEVICE_REVISION __RIO_MAI16_BLOCK_rel_dev_rev,
DD_REVISION     __RIO_MAI16_BLOCK_rel_dd_rev
/*
**********************************************************************
** Multiple Binary Input
** Definition of a multiple analog input block
**********************************************************************
*/
BLOCK   __multiple_analog_input_16_block
{
        CHARACTERISTICS __mai16_character ;
        LABEL                              [mai16_block] ;
        HELP                               [mai16_block_help] ;
        PARAMETERS
        {
                ST_REV,                 __st_rev ;
                TAG_DESC,               __tag_desc ;
        ...
        PARAMETER_LISTS
        {
                VIEW_1, __mai16_view_1 ;
                VIEW_2, __mai16_view_2 ;
                VIEW_3, __mai16_view_3 ;
                VIEW_4, __mai16_view_4 ;
        }
...
**********************************************************************
*/
VARIABLE_LIST   __mai16_view_1
{
        LABEL           [mai16_view_1] ;
        HELP            [mai16_view_1_help] ;
        MEMBERS
        {
...
VARIABLE_LIST   __mai16_view_2
{
        LABEL           [mai16_view_2] ;
        HELP            [mai16_view_2_help] ;
        MEMBERS
        {
                VL_ST_REV,              PARAM.ST_REV ;
        }
...
VARIABLE_LIST   __mai16_view_3
{
        LABEL           [mai16_view_3] ;
        HELP            [mai16_view_3_help] ;
        MEMBERS
        {
                VL_ST_REV,              PARAM.ST_REV ;
                VL_MODE_BLK,    PARAM.MODE_BLK ;
...
VARIABLE_LIST   __mai16_view_4
{
        LABEL           [mai16_view_4] ;
        HELP            [mai16_view_4_help] ;
        MEMBERS
        {
                VL_ST_REV,      PARAM.ST_REV ;
...
COLLECTION upload_wanted_mai16
{
