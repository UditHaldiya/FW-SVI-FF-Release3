/*
** @(#)pd_block.ddl     1.1 1999-03-04
**
** FF standard Proportional Derivative block
** Filename: pd_block.ddl
...
** Definition of a proportional derivative block
**********************************************************************
*/
BLOCK   __proportional_derivative_block
{
        CHARACTERISTICS     __pd_character ;
        LABEL                           [proportional_derivative_block] ;
        HELP                            [proportional_derivative_block_help] ;
        PARAMETERS
        {
                ST_REV,                 __st_rev ;
                TAG_DESC,               __tag_desc ;
                ...
                #else
                CONTROL_OPTS,   	__control_opts_pd ;
                STATUS_OPTS,    	__status_opts_pd ;
                #endif
                IN,                     __in ;
                PV_FTIME,               __pv_ftime ;
                BYPASS,                 __bypass ;
                ...
                #else
                ALARM_SUM,              __alarm_sum_pd ;
                ACK_OPTION,             __ack_option_pd ;
                #endif
