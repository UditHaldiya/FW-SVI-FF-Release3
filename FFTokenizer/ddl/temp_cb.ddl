/*
** @(#)temp_cb.ddl      1.0	2007-28-09
**
** FF Standard Temperature with Calibration for Basic Device Access
** Filename: temp_cb.ddl
...
**                  FF-904 FS 1.0  Temperature Transducer Block
**
...
/*
** HISTORY:
**      QLQ     Revision 0.9    970813
**      DAD     Revision 1.1beta 1999-03-04
**              added number system for dev rev and dd rev
**      FI      Revision 1.2beta  20051109
**              fixed view(s) per AR#766
**	MS	verified/updated against final spec 2007-11-07
** MS   ARs 2101, 2901 -- 2008.10.07
** MS   ARs 5203 -- 2010.08.13
*/
...
/*
**********************************************************************
** Standard Temperature with Calibration for Basic Device Access(Input)
**********************************************************************
*/
MANUFACTURER    __FF,
...
/*
**********************************************************************
** Temperature with Calibration for Basic Device
** Definition of standard temperature access with calibration
**********************************************************************
*/
BLOCK   __temperature_cal_basic
{
        CHARACTERISTICS __tcb_character ;
        LABEL                   [temperature_basic_block] ;
        HELP                    [temperature_basic_block_help] ;
        PARAMETERS
        {
                ST_REV,                                 __st_rev ;
                TAG_DESC,                       __tag_desc ;
                ...
                SENSOR_CONNECTION,                      __sensor_connection ;
        ...
        {
                __unit_tcb_cal_unit,
                __unit_tcb_sensor_range,
                __unit_tcb_primary_val_unit,
                __unit_tcb_second_val_unit
        }
...
**********************************************************************
*/
VARIABLE_LIST   __tcb_view_1
{
        LABEL           [tcb_view_1] ;
        HELP            [tcb_view_1_help] ;
        MEMBERS
        {
...
VARIABLE_LIST   __tcb_view_2
{
        LABEL           [tcb_view_2] ;
        HELP            [tcb_view_2_help] ;
        MEMBERS
        {
                VL_ST_REV,                              PARAM.ST_REV ;
...
VARIABLE_LIST   __tcb_view_3
{
        LABEL           [tcb_view_3] ;
        HELP            [tcb_view_3_help] ;
        MEMBERS
        {
                VL_ST_REV,                      PARAM.ST_REV ;
                VL_MODE_BLK,            PARAM.MODE_BLK ;
...
VARIABLE_LIST   __tcb_view_4
{
        LABEL           [tcb_view_4] ;
        HELP            [tcb_view_4_help] ;
        MEMBERS
        {
                /* View 4_1 */
        	VL_ST_REV,                      PARAM.ST_REV ;
		...
		VL_SENSOR_CAL_DATE,             PARAM.SENSOR_CAL_DATE ;
                ...
                VL_SENSOR_CONNECTION,           PARAM.SENSOR_CONNECTION ;
                VL_SECONDARY_VALUE_UNIT,	PARAM.SECONDARY_VALUE_UNIT ;
        }
}
/*
...
UNIT    __unit_tcb_second_val_unit
{
