/*
** @(#)mai_block.ddl 1.0 2002-06-09
**
** FF standard Multiple Analog Input block
** Filename: mai_block.ddl
...
BLOCK   __mai_block
{
   CHARACTERISTICS      __mai_character ;
   LABEL                [mai_block] ;
   HELP                 [mai_block_help] ;
   PARAMETERS
   {
...
**********************************************************************
*/
VARIABLE_LIST   __mai_view_1
{
   LABEL        [mai_view_1_label] ;
   HELP         [mai_view_1_help] ;
   MEMBERS
   {
      ...
      VL_OUT_3,         PARAM.OUT_3 ;
      VL_OUT_4,         PARAM.OUT_4 ;
      VL_OUT_5,         PARAM.OUT_5 ;
      VL_OUT_6,         PARAM.OUT_6 ;
      VL_OUT_7,         PARAM.OUT_7 ;
      VL_OUT_8,         PARAM.OUT_8 ;
   }
}

VARIABLE_LIST      __mai_view_2
{
   LABEL        [mai_view_2_label] ;
   HELP         [mai_view_2_help] ;
   MEMBERS
   {
      VL_ST_REV,      PARAM.ST_REV ;
   }
...
VARIABLE_LIST     __mai_view_3
{
   LABEL        [mai_view_3_label] ;
   HELP         [mai_view_3_help] ;
   MEMBERS
   {
      VL_ST_REV,        PARAM.ST_REV ;
      VL_MODE_BLK,      PARAM.MODE_BLK ;
...
VARIABLE_LIST     __mai_view_4
{
   LABEL        [mai_view_4_label] ;
   HELP         [mai_view_4_help] ;
   MEMBERS
   {
      VL_ST_REV,        PARAM.ST_REV ;
