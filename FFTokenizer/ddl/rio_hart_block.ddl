/*
** @(#)rio_hart_block.ddl      0.9   2009-08-07
**
** FF Standard HART Transducer Block
** Filename: rio_hart_block.ddl
...
*/
MANUFACTURER    __FF,
DEVICE_TYPE     __RIO_HART_BLOCK,
DEVICE_REVISION __RIO_HART_BLOCK_rel_dev_rev,
DD_REVISION     __RIO_HART_BLOCK_rel_dd_rev
...
**********************************************************************
*/
BLOCK    __rio_hart_xdcr_block
{
         CHARACTERISTICS       __rio_hart_xdcr_character ;
         LABEL                 [rio_hart_xdcr_block_label] ;
         HELP                  [rio_hart_xdcr_block_help] ;
         PARAMETERS
         {
            ST_REV,                    __st_rev ;
            TAG_DESC,                  __tag_desc ;
         ...
         PARAMETER_LISTS
         {
            VIEW_1, __rio_hart_xdcr_view_1 ;
            VIEW_2, __rio_hart_xdcr_view_2 ;
            VIEW_3, __rio_hart_xdcr_view_3 ;
            VIEW_4, __rio_hart_xdcr_view_4 ;
         }
         
         #ifdef UD_LISTS
	 COLLECTION_ITEMS
	 {
	 	no_download_rio_hart_xdcr
	 	,upload_wanted_rio_hart_xdcr
	 }
	 #endif
}
...
**********************************************************************
*/
RECORD      __rio_hart_xdcr_character
{
      LABEL           [blk_char] ;
      HELP            [blk_char_help] ;
      MEMBERS
...
**********************************************************************
*/
VARIABLE_LIST     __rio_hart_xdcr_view_1
{
      LABEL       [rio_hart_xdcr_view_1] ;
      HELP        [rio_hart_xdcr_view_1_help] ;
      MEMBERS
      {
...
VARIABLE_LIST     __rio_hart_xdcr_view_2
{
      LABEL       [rio_hart_xdcr_view_2] ;
      HELP        [rio_hart_xdcr_view_2_help] ;
      MEMBERS
      {
         VL_ST_REV,                    PARAM.ST_REV ;
         VL_TRANSDUCER_TYPE,           PARAM.TRANSDUCER_TYPE ;
...
VARIABLE_LIST   __rio_hart_xdcr_view_3
{
      LABEL           [rio_hart_xdcr_view_3] ;
      HELP            [rio_hart_xdcr_view_3_help] ;
      MEMBERS
      {
         VL_ST_REV,                 PARAM.ST_REV ;
         VL_MODE_BLK,               PARAM.MODE_BLK ;
...
VARIABLE_LIST     __rio_hart_xdcr_view_4
{
      LABEL       [rio_hart_xdcr_view_4] ;
      HELP        [rio_hart_xdcr_view_4_help] ;
      MEMBERS
      {
         VL_ST_REV,                 PARAM.ST_REV ;
...
*/
#ifdef UD_LISTS
COLLECTION no_download_rio_hart_xdcr
{
...
COLLECTION upload_wanted_rio_hart_xdcr
{
