/*
** @(#)pidblock.ddl     1.1 1999-03-04
**
** FF standard Proportional Integral Derivative block
** Filename: pidblock.ddl
...
** Definition of a proportional integral derivative block
**********************************************************************
*/
BLOCK      __proportional_integral_derivative_block
{
        CHARACTERISTICS     __pid_character ;
        LABEL                           [proportional_integral_derivative_block] ;
        HELP                            [proportional_integral_derivative_block_help] ;
        PARAMETERS
        {
                ST_REV,                 __st_rev ;
                TAG_DESC,               __tag_desc ;
                ...
                #else
                CONTROL_OPTS,   	__control_opts_pid ;
                STATUS_OPTS,    	__status_opts_pid ;
                #endif
                IN,                     __in ;
                PV_FTIME,               __pv_ftime ;
                BYPASS,                 __bypass ;
                ...
                #else
                ALARM_SUM,              __alarm_sum_pid ;
                ACK_OPTION,             __ack_option_pid ;
                #endif
...
**********************************************************************
*/
VARIABLE_LIST   __pid_view_1
{
        LABEL           [pid_view_1] ;
        HELP            [pid_view_1_help] ;
        MEMBERS
        {
...
VARIABLE_LIST   __pid_view_2
{
        LABEL           [pid_view_2] ;
        HELP            [pid_view_2_help] ;
        MEMBERS
        {
                VL_ST_REV,              PARAM.ST_REV ;
...
VARIABLE_LIST   __pid_view_3
{
        LABEL           [pid_view_3] ;
        HELP            [pid_view_3_help] ;
        MEMBERS
        {
                VL_ST_REV,              PARAM.ST_REV ;
                VL_MODE_BLK,    PARAM.MODE_BLK ;
                ...
                VL_ROUT_IN,             PARAM.ROUT_IN ;
                VL_RCAS_OUT,    PARAM.RCAS_OUT ;
                VL_ROUT_OUT,    PARAM.ROUT_OUT ;
                VL_TRK_IN_D,    PARAM.TRK_IN_D ;
                VL_TRK_VAL,             PARAM.TRK_VAL ;
                VL_FF_VAL,              PARAM.FF_VAL ;
                VL_ALARM_SUM,   PARAM.ALARM_SUM ;
        }
}

VARIABLE_LIST   __pid_view_4
{
        LABEL           [pid_view_4] ;
        HELP            [pid_view_4_help] ;
        MEMBERS
        {
                VL_ST_REV,                      PARAM.ST_REV ;
                ...
                VL_RATE,                           PARAM.RATE ;
                VL_BKCAL_HYS,           PARAM.BKCAL_HYS ;
                VL_SHED_OPT,            PARAM.SHED_OPT ;
                VL_TRK_SCALE,           PARAM.TRK_SCALE ;
                VL_FF_SCALE,            PARAM.FF_SCALE ;
                VL_FF_GAIN,                     PARAM.FF_GAIN ;
...
UNIT    __unit_pid_ff
{
        PARAM.FF_SCALE.UNITS_INDEX :
                PARAM.FF_VAL.VALUE,
                PARAM.FF_SCALE.EU_100,
                PARAM.FF_SCALE.EU_0
}
/*
**********************************************************************
