/*
** @(#)resblock.ddl 1.2 1999-03-04
**
** FF standard Resource block
** Filename: resblock.ddl
...
**  QLQ Revision 1.1  19970915 (change fail-safe to fault-state)
...
**********************************************************************
*/
BLOCK      __resource_block
{
    CHARACTERISTICS     __res_character ;
    LABEL               [resource_block] ;
    HELP                [resource_block_help] ;
    PARAMETERS
    {
        ST_REV,         __st_rev ;
        TAG_DESC,       __tag_desc ;
...
VARIABLE_LIST   __res_view_2
{
    LABEL       [res_view_2] ;
    HELP        [res_view_2_help] ;
    MEMBERS
    {
        VL_ST_REV,          PARAM.ST_REV ;
...
VARIABLE_LIST   __res_view_3
{
    LABEL       [res_view_3] ;
    HELP        [res_view_3_help] ;
    MEMBERS
    {
        VL_ST_REV,      PARAM.ST_REV ;
        VL_MODE_BLK,    PARAM.MODE_BLK ;
...
VARIABLE_LIST   __res_view_4
{
    LABEL       [res_view_4] ;
    HELP        [res_view_4_help] ;
    MEMBERS
    {
        VL_ST_REV,      PARAM.ST_REV ;
