/*
** @(#)cust_calc_block.ddl      1.0	2009-06-15
**
** FF Custom Calculation Block
...
** Description:
** 	"Skeleton" block definition as per FF-890 Calculation Function
...
{
        CHARACTERISTICS		__custom_calc_character ;
        LABEL                   [custom_calc_block] ;
        HELP                    [custom_calc_block_help] ;
        PARAMETERS
        {
                ST_REV,				__st_rev ;
                TAG_DESC,                       __tag_desc ;
        ...
        PARAMETER_LISTS
        {
                VIEW_1, __custom_calc_view_1 ;
                VIEW_2, __custom_calc_view_2 ;
                VIEW_3, __custom_calc_view_3 ;
                VIEW_4, __custom_calc_view_4 ;
        }
        
        #ifdef UD_LISTS
	COLLECTION_ITEMS
	{
		no_download_custom_calc
		,upload_wanted_custom_calc
	}
	#endif
}
/*
...
**********************************************************************
*/
RECORD      __custom_calc_character
{
    LABEL           [blk_char] ;
    HELP            [blk_char_help] ;
    MEMBERS
...
{
        LABEL           [custom_calc_view_1] ;
        HELP            [custom_calc_view_1_help] ;
        MEMBERS
        {
...
VARIABLE_LIST   __custom_calc_view_2
{
        LABEL           [custom_calc_view_2] ;
        HELP            [custom_calc_view_2_help] ;
        MEMBERS
        {
                VL_ST_REV,     		PARAM.ST_REV ;
        }
...
{
        LABEL           [custom_calc_view_3] ;
        HELP            [custom_calc_view_3_help] ;
        MEMBERS
        {
                VL_ST_REV,              PARAM.ST_REV ;
                VL_MODE_BLK,            PARAM.MODE_BLK ;
...
VARIABLE_LIST   __custom_calc_view_4
{
        LABEL           [custom_calc_view_4] ;
        HELP            [custom_calc_view_4_help] ;
        MEMBERS
        {
                VL_ST_REV,		PARAM.ST_REV ;
...
*/
#ifdef UD_LISTS
COLLECTION no_download_custom_calc
{
...
COLLECTION upload_wanted_custom_calc
{
