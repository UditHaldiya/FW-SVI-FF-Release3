/*
** @(#)rio_assoc_block.ddl     1.0 2009-06-22
**
** FF standard Remote IO Association Transducer Block
** Filename: rio_assoc_block.ddl
...
/*
**********************************************************************
** RIO Association block
**********************************************************************
*/
MANUFACTURER    __FF,
DEVICE_TYPE     __RIO_ASSOC_BLOCK,
DEVICE_REVISION __RIO_ASSOC_BLOCK_rel_dev_rev,
DD_REVISION     __RIO_ASSOC_BLOCK_rel_dd_rev
/*
**********************************************************************
** Association Block
** Skeleton of the Association Transducer Block
**********************************************************************
*/
BLOCK   __association_block
{
        CHARACTERISTICS __ab_character ;
        LABEL                              [ab_block] ;
        HELP                               [ab_block_help] ;
        PARAMETERS
        {
