/*
** @(#)temp_cb2.ddl      1.0	2011-04-22
**
** FF Standard Temperature with Calibration for Basic Device Access 2
** Filename: temp_cb2.ddl
...
**********************************************************************
*/
BLOCK   __temperature_cal_basic2
{
        CHARACTERISTICS __tcb2_character ;
        LABEL                   [temperature_basic_block2] ;
        ...
        PARAMETER_LISTS
        {
                VIEW_1, __tcb2_view_1 ;
                VIEW_2, __tcb2_view_2 ;
                VIEW_3, __tcb2_view_3 ;
                VIEW_4, __tcb2_view_4 ;
        }
        UNIT_ITEMS
        {
                __unit_tcb2_cal_unit,
                __unit_tcb2_sensor_range,
                __unit_tcb2_primary_val_unit
        }
