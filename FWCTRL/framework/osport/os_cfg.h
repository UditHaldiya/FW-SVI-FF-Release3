...
#define OS_RTOS_VALIDATION        0
#define OS_CHECK_IRQ_STACK        0
...
#define OS_TICKS_PER_SEC TB_TICKS_PER_SEC  /* Set the number of ticks in one second                        */
...
#define OS_SEM_SET_EN             0    /* Enable (1) or Disable (0) code generation for SEMAPHORES     */
...
#define OS_TASK_NAME_SIZE        11    /*     Determine the size of a task name                        */
